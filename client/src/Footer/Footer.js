...
import logo from "./../Navbar/Market Mantra.png"
                    ...
                    <div className="row gy-4 gy-lg-0 justify-content-xl-between">
                        <div className="col-12 col-md-4 col-lg-3 col-xl-2">
                            <div className="widget">
                                <Link href="/">
                                    <img src={logo} alt="BootstrapBrain Logo" className='footer-logo' />
                                </Link>
                                
                                <h2 style={{color: 'white'}}>Market मंत्र</h2>
                            </div>
                        </div>
                        <div className="col-12 col-md-4 col-lg-3 col-xl-2">
                            <div className="widget">
                                <h4 className="widget-title mb-4">Get in Touch</h4>
                                <p  className="mb-4">Balaji Nager Sambhaji Chowk Nagpur , Maharashtra</p >
                                <p className="mb-1">
                                    <Link className="link-secondary text-decoration-none" href="tel:9130895209">+91-9130895209</Link>
                                </p>
                                <p className="mb-0">
                                    <Link className="link-secondary text-decoration-none" href="mailto:atharvneware28@gmail.com">atharvneware28@gmail.com</Link>
                                </p>
                            </div>
                        </div>
                        <div className="col-12 col-md-4 col-lg-3 col-xl-2">
                            <div className="widget">
                                ...
                                <ul className="list-unstyled">
                                    <li className="mb-2">
                                        <Link href="/" className="link-secondary text-decoration-none">About</Link>
                                    </li>
                                    <li className="mb-2">
                                        <Link href="/" className="link-secondary text-decoration-none">Contact</Link>
                                    </li>
                                    {/* <li className="mb-2">
                                        <Link href="/" className="link-secondary text-decoration-none">Advertise</Link>
                                    </li>
                                    <li className="mb-2">
                                        <Link href="/" className="link-secondary text-decoration-none">Terms of Service</Link>
                                    </li> */}
                                    <li className="mb-0">
                        ...
                        <div className="col-12 col-lg-3 col-xl-4">
                            <div className="widget">
                                <h4 className="widget-title mb-4">Our Resources </h4>
                                <p className="mb-4">Send your Email , We can Contact You</p>
                                <form action="#!">
                    ...
                    <div className="row gy-4 gy-md-0 align-items-md-center">
                        <div className="col-xs-12 col-md-7 order-1 order-md-0">
                            ...
                            <div className="credits text-secondary text-center text-md-start mt-2 fs-8">
                                Built by <Link href="https://bootstrapbrain.com/" className="link-secondary text-decoration-none">BootstrapBrain</Link> with <span className="text-primary">&#9829;</span>
                            </div>
                        </div>
